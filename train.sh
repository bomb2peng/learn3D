...
#    --sample_dir=/hd2/pengbo/mesh_reconstruction/models/AE529_cont1/sample3D_${j}_AE529_cont1 \
#    --ckpt_dir=/hd2/pengbo/mesh_reconstruction/models/AE529_cont1/ckpt3D_${j}_AE529_cont1/  \
...
#    --n_epochs=50 --decay_epoch=40 --decay_every=10 --decay_order=0.1 --visdom_env=log3D-AE529-cont1_${j} \
...
# Evaluations
    ...
    --obj_dir=/hd2/pengbo/mesh_reconstruction/models/template_obj/sphere_642.obj \
    --ckpt_dir=/hd2/pengbo/mesh_reconstruction/models/AEfeatGAN604_cont1/ckpt3D_${j}_AEfeatGAN604_cont1 \
    --device_id=0 --class_ids=${j} --img_size=64 --latent_dim=512 --eval_flag=last #--use_VAE
...
#    --sample_dir=/hd2/pengbo/mesh_reconstruction/models/AEfeatGAN604_cont1/sample3D_${j}_AEfeatGAN604_cont1 \
#    --ckpt_dir=/hd2/pengbo/mesh_reconstruction/models/AEfeatGAN604_cont1/ckpt3D_${j}_AEfeatGAN604_cont1 \
#    --obj_dir=/hd2/pengbo/mesh_reconstruction/models/template_obj/sphere_642.obj \
#    --sample_step=500 --n_epochs=20 --decay_epoch=15 --decay_every=10 --decay_order=0.1 --device_id=0 \
#    --class_ids=${j} --img_size=64 --lambda_smth=0.001 --latent_dim=512 --visdom_env=log3D-AEfeatGAN604-cont1_${j} \
#    --G_every=1 --lambda_Gprior=0 \
...
#    for i in {0..9}
#    do
#        CUDA_VISIBLE_DEVICES=2 python 3D-GAN.py --mode=reconstruct \
#        --obj_dir=/hd2/pengbo/mesh_reconstruction/models/template_obj/sphere_642.obj \
#        --sample_dir=/hd2/pengbo/mesh_reconstruction/models/reconstruction/examples_AEfeatGAN529 \
#        --device_id=0 --img_size=64 --latent_dim=512 \
#        --load_im=/hd2/pengbo/mesh_reconstruction/models/reconstruction/examples/${j}_${i}.png \
#        --load_G=/hd2/pengbo/mesh_reconstruction/models/AEfeatGAN529/ckpt3D_${j}_AEfeatGAN529/last-G.ckpt \
#        --load_E=/hd2/pengbo/mesh_reconstruction/models/AEfeatGAN529/ckpt3D_${j}_AEfeatGAN529/last-E.ckpt
#    done
...
#        --obj_dir=/hd2/pengbo/mesh_reconstruction/models/template_obj/sphere_642.obj \
#        --sample_dir=/hd2/pengbo/mesh_reconstruction/models/reconstruction/interpo_AEfeatGAN529 \
#        --device_id=0 --img_size=64 --latent_dim=512 \
...
#    --load_E=/hd2/pengbo/mesh_reconstruction/models/AEfeatGAN529/ckpt3D_${j}_AEfeatGAN529/last-E.ckpt #--use_VAE

#    ## MMD between features of different poses
#    CUDA_VISIBLE_DEVICES=2 python 3D-GAN.py --mode=MMD --data_dir=/hd2/pengbo/mesh_reconstruction/dataset/ \
#    --n_epochs=1 --device_id=0 \
#    --class_ids=${j} --img_size=64 --latent_dim=512 \
#    --load_E=/hd2/pengbo/mesh_reconstruction/models/AE529/ckpt3D_${j}_AE529/last-E.ckpt #--use_VAE
done
...
#--sample_dir=/hd2/pengbo/mesh_reconstruction/models/sample3D_temp1 \
#--ckpt_dir=/hd2/pengbo/mesh_reconstruction/models/ckpt3D_temp1 \
#--obj_dir=/hd2/pengbo/mesh_reconstruction/models/template_obj/sphere_642.obj \
#--sample_step=500 --n_epochs=1 --decay_epoch=15 --decay_every=10 --decay_order=0.1 --device_id=0 \
#--class_ids=02958343 --img_size=64 --lambda_smth=0.001 --latent_dim=512 --visdom_env=log3D-temp_1 \
#--G_every=5 --batches_done=39358 \
#--load_E=/hd2/pengbo/mesh_reconstruction/models/ckpt3D_temp1/last-E.ckpt \
#--load_G=/hd2/pengbo/mesh_reconstruction/models/ckpt3D_temp1/last-G.ckpt \
#--load_D=/hd2/pengbo/mesh_reconstruction/models/ckpt3D_temp1/last-D.ckpt
...
### t-SNE visualization
#CUDA_VISIBLE_DEVICES=1 python 3D-GAN.py --mode=t_SNE --data_dir=/hd2/pengbo/mesh_reconstruction/dataset/ \
#--n_epochs=1 --device_id=0 \
#--class_ids=02958343 --img_size=64 --latent_dim=512 \
#--load_E=/hd2/pengbo/mesh_reconstruction/models/AE529/ckpt3D_02958343_AE529/last-E.ckpt #--use_VAE

### reconstruction results on an image
#CUDA_VISIBLE_DEVICES=3 python 3D-GAN.py --mode=reconstruct \
#--obj_dir=/hd2/pengbo/mesh_reconstruction/models/template_obj/sphere_642.obj \
#--sample_dir=/hd2/pengbo/mesh_reconstruction/models/reconstruction/examples2_AE529 \
#--device_id=0 --img_size=64 --latent_dim=512 \
#--load_im=/hd2/pengbo/mesh_reconstruction/models/reconstruction/examples2/02691156_0.png \
#--load_G=/hd2/pengbo/mesh_reconstruction/models/AE529/ckpt3D_02691156_AE529/last-G.ckpt \
#--load_E=/hd2/pengbo/mesh_reconstruction/models/AE529/ckpt3D_02691156_AE529/last-E.ckpt
...
#--n_epochs=1 --device_id=0 \
#--class_ids=02958343 --img_size=64 --latent_dim=512 \
#--load_E=/hd2/pengbo/mesh_reconstruction/models/AEfeatGAN529/ckpt3D_02958343_AEfeatGAN529/last-E.ckpt #--use_VAE
